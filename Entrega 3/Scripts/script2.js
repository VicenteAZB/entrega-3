$(document).ready(function() {
  ...
  // Función que muestra información y cambia el color del párrafo
  function muestraInfoCambiaColor(descripcion, color) {
    infoParrafo.html(descripcion).css('color', color);
  }

  // Función que limpia el párrafo y restablece el color
  function limpiaParrafo(descripcion) {
    infoParrafo.html(descripcion).css('color', 'white');
  }

  // Asocia eventos de mouseover y mouseout a los elementos seleccionados
